...
public class Professor extends AppCompatActivity {
    ...
    public void AbrirArquivoAtual(View view) {
        String url = "https://drive.google.com/folderview" +
                "?id=0B9AED1AJbX9qMmxWY2RTZExsS1k&usp=sharing/";
    ...
    public void selecionarArquivoProfessor(View view){
